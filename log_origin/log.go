...
import (
	...
	"github.com/chenzanhong/logs/log_origin/internal"
)
...
func (l *Logger) OutputBuffer(calldepth int, s string) *[]byte {
	calldepth++ // +1 for this frame.
	return l.outputBuffer(0, calldepth, func(b []byte) []byte {
		return append(b, s...)
	})
}
...
func (l *Logger) outputBuffer(pc uintptr, calldepth int, appendOutput func([]byte) []byte) *[]byte {
	if l.isDiscard.Load() {
		return nil
	}
